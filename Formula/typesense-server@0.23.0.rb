class TypesenseServerAT0230 < Formula
  desc "Search Engine; Open Source, Lightning fast, In-Memory, Typo Tolerant"
  homepage "https://typesense.org"
  url "https://dl.typesense.org/releases/0.23.0/typesense-server-0.23.0-darwin-amd64.tar.gz"
  version "0.23.0"
  sha256 "e797e3224a2f1bdd4508c2604326d8e59adb8207125993e0c4593d4b6014eb2a"
  license "GPL-3.0"
