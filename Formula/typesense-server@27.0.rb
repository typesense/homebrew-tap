class TypesenseServerAT270 < Formula
  ...
  if Hardware::CPU.arm?
    url "https://dl.typesense.org/releases/27.0/typesense-server-27.0-darwin-arm64.tar.gz"
    sha256 "eaef54f55c30da6f91de9c06eb086f2a0adcb1c92a0682b90dfbad1a44298aa2"
  else
    url "https://dl.typesense.org/releases/27.0/typesense-server-27.0-darwin-amd64.tar.gz"
    sha256 "dca858c7159924ecfb5d69b4721bc78f6aba7cd1956ac54842ff94899471dc4e"
  end
